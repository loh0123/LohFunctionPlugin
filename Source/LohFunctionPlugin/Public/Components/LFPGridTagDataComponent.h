...
public:
	...
	UFUNCTION(BlueprintPure, Category = "LFPGridTagDataComponent | Getter")
	FIntVector ToGridPosition( const FIntVector GridIndex , const bool bRound = false ) const;

	UFUNCTION(BlueprintPure, Category = "LFPGridTagDataComponent | Getter")
	FIntVector ToGridIndex( FIntVector GridPosition , const bool bRound = false ) const;
