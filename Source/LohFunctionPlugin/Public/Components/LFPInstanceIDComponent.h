...
struct FLFPInstanceGridMeshData
{
	...
	FLFPInstanceGridMeshData( UInstancedStaticMeshComponent* ISM ) :
		ISMComponent(ISM)
	{
	}
...
public:
	...
	FORCEINLINE void EmptyInstance( );
};
...
public:
	...
	/* Function For External Blueprint Or C++ To Use */
	...
	/* Register All Children That Are Instance Static Mesh. Execute Only If There Are No Registered Mesh */
	UFUNCTION(BlueprintCallable, Category = "LFPInstanceIDComponent | Initializer")
	bool RegisterChildrenInstanceStaticMeshComponent( );
