...
FIntVector ULFPChunkedGridSetting::ToChunkGridPosition ( const FIntPoint ChunkGridIndex , const bool bRound ) const
{
...
FIntPoint ULFPChunkedGridSetting::ToChunkGridIndex ( FIntVector ChunkGridPosition , const bool bRound ) const
{
...
FIntVector ULFPChunkedGridSetting::ToDataGridPosition ( const FIntVector DataGridIndex , const bool bRound ) const
{
...
FIntVector ULFPChunkedGridSetting::ToDataGridIndex ( FIntVector DataGridPosition , const bool bRound ) const
{
	auto DivideVector = [&] ( const FIntVector& A , const FIntVector& B )
	{
		return FIntVector ( A.X / B.X , A.Y / B.Y , A.Z / B.Z );
