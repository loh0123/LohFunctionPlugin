...
void ULFPDynamicTypeLibrary::InitializeTrackerArray( UPARAM(ref)FLFPIndexTrackerStaticArray& List , const int32 IndexSize )
{
	List = FLFPIndexTrackerStaticArray(IndexSize);
}

int32 ULFPDynamicTypeLibrary::GetNewID( UPARAM(ref)FLFPIndexTrackerStaticArray& List )
{
	return List.GetNewID();
}

bool ULFPDynamicTypeLibrary::SetID( UPARAM(ref)FLFPIndexTrackerStaticArray& List , const int32 Index , const int32 ID )
{
